...
/**
 * @file
 * Optimized autoloader for the MERIDIAN_SUBTHEME.
 *
...
namespace {
  ...
  if (!defined('MERIDIAN_SUBTHEME_AUTOLOADER_LOADED')) {
    define('MERIDIAN_SUBTHEME_AUTOLOADER_LOADED', TRUE);


    // Register the MERIDIAN_SUBTHEME autoloader.
    spl_autoload_register(function ($class) {
      $prefix = 'Drupal\\MeridianSubtheme\\';
