...
The footer integrates with Meridian's theme system:

- **Page template**: Invoked directly via `page.html.twig`
- **Drupal regions**: Each slot maps to a Drupal region (defined in `meridian.info.yml`)
- **Theme settings**: Theme can be configured via UI at `/admin/appearance/settings/meridian`
