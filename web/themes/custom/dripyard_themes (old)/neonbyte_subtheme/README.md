...
```bash
php web/core/scripts/drupal generate-theme --starterkit neonbyte_subtheme my_custom_theme --path themes/dripyard_themes
```

You can safely ignore the `The source theme neonbyte_subtheme does not have a version specified.` notice as we will not be running this again once your custom theme is created.
...
```bash
neonbyte=neonbyte php web/core/scripts/drupal generate-theme --starterkit neonbyte_subtheme my_custom_theme --path themes/dripyard_themes
```
