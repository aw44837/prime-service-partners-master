...
/**
 * @file
 * Optimized autoloader for the Meridian theme.
 *
...
namespace {
  ...
  if (!defined('DRIPYARD_MERIDIAN_AUTOLOADER_LOADED')) {
    define('DRIPYARD_MERIDIAN_AUTOLOADER_LOADED', TRUE);

    /**
     * Register the Meridian autoloader.
     */
    spl_autoload_register(function ($class) {
      $prefix = 'Drupal\\meridian\\';
